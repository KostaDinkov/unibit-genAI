# UNIBIT - Generative Artificial Intelligence

This project is a part of the UNIBIT project, which aims to develop a generative artificial intelligence model that can generate code snippets, documentation, and other technical content. The project leverages the OpenAI API to generate text-based completions for various prompts.
When run, the project will start a development server that allows users to interact with the AI model by submitting prompts and receiving responses about startup ideas.

Part of the source code is generated by ChatGPT 3, as per project requirements. Below is a screenshot of the running application:
