...
This project is a part of the UNIBIT course "Data Analysis and management", which aims to develop a generative artificial intelligence model for a chat bot. The project leverages the OpenAI API to generate text-based completions for various prompts.
